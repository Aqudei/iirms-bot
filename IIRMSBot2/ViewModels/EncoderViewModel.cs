...
namespace IIRMSBot2.ViewModels
{
    internal sealed class EncoderViewModel : Screen
    {
        ...
        // https://orange-green.cf/api/Encoding/checkFolder [GET]
        // https://orange-green.cf/api/Encoding/upload [POST] params := file [binary]
        // Add doc info
        // https://orange-green.cf/api/Encoding/new [POST] params 
        /*
        ...
        public bool IsFileServerAvailable
        {
            get
            {
                var url = "https://orange-green.cf/api/Encoding/checkFolder";
        ...
        {
            var url =
                $"https://orange-green.cf/api/Encoding/reportnumber?reportNumber={reportNumber}";
        ...
        private NewResult SubmitDocumentInfo(UploadResult uploadResult, Item encodeItem)
        {
            try
            {
                ...
                var url = "https://orange-green.cf/api/Encoding/new";
        ...
        private UploadResult UploadFile(Item item)
        {
            ...
            var request = new RestRequest("https://orange-green.cf/api/Encoding/upload", Method.POST);
